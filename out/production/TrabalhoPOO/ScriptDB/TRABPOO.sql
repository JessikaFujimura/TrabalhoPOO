...
CREATE TABLE ALUNOS (IDALUNO int AUTO_INCREMENT PRIMARY KEY, NOMEALUNO varchar(150),SERIE varchar(10), N1 decimal(10,2), N2 decimal(10,2),N3 decimal(10,2),N4 decimal(10,2),FALTA int);

INSERT INTO ALUNOS (NOMEALUNO,SERIE,N1,N2,N3,N4, FALTA) VALUES ('João Silva',3, 8.0, 5.5, 7.0, 6.5, 2), ('Maria', 2 , 5.0, 7.5, 8.0, 10.0, 0);
INSERT INTO ALUNOS (NOMEALUNO,SERIE,N1,N2,N3,N4, FALTA) VALUES ('Maria',2, 5.0, 7.5, 8.0, 10.0, 0);

INSERT INTO ALUNOS (NOMEALUNO,SERIE,N1,N2,N3,N4, FALTA) VALUES ('Jose Moreira',5, 4.0, 7.5, 3.0, 9.5, 5);
